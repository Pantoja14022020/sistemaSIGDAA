...
<html>
    ...
    <body>
      ...
      <section class="form-registro">
          ...
          <form action="/transferencia_primaria" method="POST">
            @csrf
            <label for="numero_tp">Número Trasferencia Primaria</label>
              <input class="controls" type="text" name="numero_tp" id="NumTP">
              <label for="dep_o_unid">Dependencia/UnidadAcadémica</label>
              <select class="controls" name="dep_o_unid" id="seleccionarTipoOrganizacion">
                ...
                <select class="controls" id="" name="area_generadora">
                  ...
                  <option value="value2">Coordinación</option>
                  <option value="value3">Departamento</option>
                  <option value="value4">Oficina</option>
                </select>
              ...
              <select class="controls" id="selectSeccion" name="seccion">
                ...
                <label for="no_caja">Número Caja</label>
                <input class="controls" type="number" name="no_caja" id="NC">
                <label for="no_expediente">Número Expediente</label>
                <input class="controls" type="number" name="no_expediente" id="NExpe">
                <label for="t_expediente">Título Expediente</label>
                <input class="controls" type="text" name="t_expediente" id="TituExpe">
                <label for="soporte">Soporte</label>
                <select class="controls" name="soporte">
                  <option value="0" selected>Seleccionar</option>
                  <option value="1">Físico</option>
                  <option value="2">Electrónico</option>
                </select>
                <label for="f_apertura">Fecha Apertura</label>
                ...
                <!--<label for="NLegagos">Asunto</label>
                <input class="controls" type="number" name="NLegagos" id="NLega">-->
                <label for="n_legagos">Número Legajos</label>
                <input class="controls" type="number" name="n_legagos" id="NLegagos">
                <label for="a_guarda">Años Guarda en Archivo de Concentración</label>
                <input class="controls" type="number" name="a_guarda" id="AGAC">
                <label for="f_valoracion">Fecha Valoración</label>
                <input class="controls" type="date" name="f_valoracion" id="FValo">
      ...
      <script src="{{ asset('js/transferencia_primaria.js') }}"></script>
    </body>
</html>